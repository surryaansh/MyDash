    ...
    <svg ref={faceRef} fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="67 105 745 364">
      ...
      <g clipPath="url(#leftEyeClip)">
        <g transform={`translate(${leftPupil.dx}, ${leftPupil.dy})`}>
          <ellipse cx="213" cy="387" rx="50" ry="30" fill="currentColor"/>
          <ellipse cx="230" cy="370" rx="12" ry="8" fill={pupilHighlightColor} opacity="0.8" />
        </g>
      </g>
      ...
      <g clipPath="url(#rightEyeClip)">
        <g transform={`translate(${rightPupil.dx}, ${rightPupil.dy})`}>
          <ellipse cx="667" cy="387" rx="50" ry="30" fill="currentColor"/>
          <ellipse cx="684" cy="370" rx="12" ry="8" fill={pupilHighlightColor} opacity="0.8" />
        </g>
      </g>
