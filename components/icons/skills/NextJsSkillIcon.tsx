 ...
 * Features a perfectly balanced logo and text lockup.
 */
export const NextJsSkillIcon: React.FC<IconProps> = ({ className }) => {
  return (
    <div className={`${className} flex items-center justify-center gap-1.5 md:gap-2`}>
      ...
      <svg
        viewBox="0 0 512 512"
        className="h-[85%] w-auto flex-shrink-0"
      ...
      >
        <g transform="translate(.722 .64) scale(6.375)">
          ...
          <path
            ...
            fill="url(#nextjs-gradient-center)"
            fillRule="nonzero"
          />
          <path fill="url(#nextjs-gradient-side)" d="M51.111 24h5.333v32h-5.333z" />
        </g>
        <defs>
          <linearGradient
            id="nextjs-gradient-center"
            x1="0"
            y1="0"
            x2="1"
            y2="0"
