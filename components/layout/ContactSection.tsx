...
export const ContactSection: React.FC<ContactSectionProps> = ({ isDarkMode, cursorPosition }) => {
  ...
  return (
    <section id="contact" className={`flex flex-col lg:flex-row flex-1 border-t min-h-[60vh] divide-y-0 lg:divide-x ${borderClasses} ${divideClasses}`}>
      <ContactLeftPanel 
      ...
      />
      {/* Hide right panel on mobile since it's merged into left panel */}
      <ContactRightPanel
        isDarkMode={isDarkMode}
        onHoverChange={setIsConnectHovered}
