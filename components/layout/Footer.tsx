    ...
    <footer className="w-full">
      ...
      <div className="py-4">
        ...
        <div className="flex justify-between items-center mt-4">
          <nav className="flex flex-wrap justify-start gap-x-8 gap-y-2 text-lg">
      ...
      {/* Blank space for the logo */}
      <div className="w-full min-h-[10rem] md:min-h-[15rem] flex items-center justify-center">
        {/* Intentionally left blank as per request for the large logo */}
      </div>
